# There is a village with 10 people. Every night one random person gets turned into a random animal then turns back the next morning. 
...
# Write a program that will run the scenario until all the villagers but one are gone and see how many nights they survive.
